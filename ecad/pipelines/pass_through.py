...
from ecad.transformer_2d_models.pass_through_transformer_2d import (
    PassThroughTransformer2D,
)
...
class PassThroughTransformerPipeline(PixArtAlphaPipeline):
    def __init__(
        self,
        ...
        self.transformer.forward = PassThroughTransformer2D.forward
